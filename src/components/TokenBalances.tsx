...
export default function TokenBalances({ address }: TokenBalancesProps) {
  ...
  // Koristimo Dune Echo Hook za dohvaćanje stanja tokena
  const { data, isLoading: hookLoading, error: hookError } = useTokenBalances(address);
  ...
  }, [data, hookLoading, hookError, address, previousTokens, tokens]);
