  ...
  blokovi: [
    {
      ...
      transactions: [
        "0xaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa1111",
      ],
    },
    {
      number: "12345677",
      ...
      transactions: [
        "0xaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa2222",
      ],
    },
    {
      number: "12345676",
      ...
      transactions: [
        "0xaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa3333",
      ],
    },
    {
      number: "12345675",
      ...
      transactions: [
        "0xaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa4444",
      ],
    },
    {
      number: "12345674",
      ...
      transactions: [
        "0xaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa5555",
      ],
    },
  ],
  adrese: [
...
function pretrazi(upit) {
  ...
  if (!upit || upit.trim() === "") {
    prikaziGresku(
      "Unesite adresu, hash transakcije ili broj bloka za pretraživanje"
    );
    return;
  }
  ...
  if (upit.startsWith("0x") && upit.length >= 40) {
    const adresa = mockPodaci.adrese.find(
      (a) => a.adresa.toLowerCase() === upit
    );
    if (adresa) {
  ...
  if (upit.startsWith("0x") && upit.length >= 60) {
    const transakcija = mockPodaci.transakcije.find(
      (t) => t.hash.toLowerCase() === upit
    );
    if (transakcija) {
  ...
  prikaziGresku(
    "Neispravan format upita. Unesite adresu, hash transakcije ili broj bloka."
  );
}
...
function prikaziAdresu(adresa) {
  ...
  const adresaTransakcije = mockPodaci.transakcije.filter(
    (t) =>
  ...
  adresaTransakcije.forEach((tx) => {
    transakcijeHTML += `
      <tr class="table-row">
        ...
        <td class="px-4 py-3 text-sm text-gray-400">${formatirajVrijeme(
          tx.blockTimestamp
        )}</td>
      ...
      <div class="p-4">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <div>
            ...
            <p class="text-white">${formatirajVrijeme(
              transakcija.blockTimestamp
            )}</p>
          </div>
          ...
          <div>
            ...
            <p class="text-white">${
              parseInt(transakcija.gasPrice) / 1000000000
            } Gwei</p>
          </div>
...
function prikaziBlok(blok) {
  ...
  const blokTransakcije = mockPodaci.transakcije.filter(
    (t) => t.blockNumber === blok.number
  );
